...
const products: Product[] = [
 ...
 // Meat & Seafood - Seller 1
  // Chicken (Kozhi)
  { id: 'prod-chicken-curry-cut', name: 'Chicken Curry Cut', description: 'Bone-in pieces, perfect for curries and sambar. Halaal certified.', price: 180, stock: 50, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-chicken-curry-cut')!.imageUrl, imageHint: 'chicken curry cut', sellerId: 'seller-1', subCategory: 'Chicken (Kozhi)', tags: ['Halaal', 'Antibiotic-free'] },
  { id: 'prod-chicken-boneless', name: 'Boneless Chicken Breast', description: 'Tender, skinless chicken breast strips. Ideal for stir-fries and snacks.', price: 250, stock: 40, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-chicken-boneless')!.imageUrl, imageHint: 'boneless chicken', sellerId: 'seller-1', subCategory: 'Chicken (Kozhi)', tags: ['Halaal', 'Antibiotic-free'] },
  { id: 'prod-nattu-kozhi', name: 'Country Chicken (Nattu Kozhi)', description: 'Whole country chicken, valued for its distinct flavor in traditional gravies.', price: 450, stock: 20, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-country-chicken')!.imageUrl, imageHint: 'country chicken', sellerId: 'seller-1', subCategory: 'Chicken (Kozhi)', tags: ['Antibiotic-free'] },

  // Mutton & Lamb (Aattu Iraichi)
  { id: 'prod-mutton-curry-cut', name: 'Mutton Curry Cut', description: 'A mix of bone-in and boneless pieces for rich, flavorful curries. Halaal certified.', price: 450, stock: 30, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-mutton-curry-cut')!.imageUrl, imageHint: 'mutton curry cut', sellerId: 'seller-1', subCategory: 'Mutton & Lamb (Aattu Iraichi)', tags: ['Halaal'] },
  { id: 'prod-mutton-keema', name: 'Mutton Keema', description: 'Finely minced mutton, perfect for keema curry or kola urundai. Halaal certified.', price: 500, stock: 25, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-mutton-keema')!.imageUrl, imageHint: 'mutton mince', sellerId: 'seller-1', subCategory: 'Mutton & Lamb (Aattu Iraichi)', tags: ['Halaal'] },

  // Fresh Seafood (Meen Vagaigal)
  { id: 'prod-seer-fish', name: 'Vanjaram (Seer Fish) Slices', description: 'Fresh catch of the day. Firm, flavorful steaks perfect for frying.', price: 600, stock: 15, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-seer-fish')!.imageUrl, imageHint: 'seer fish', sellerId: 'seller-1', subCategory: 'Fresh Seafood (Meen Vagaigal)', tags: ['Fresh Catch'] },
  { id: 'prod-prawns', name: 'Cleaned Prawns (Iral)', description: 'Medium-sized prawns, deveined and ready to cook. Fresh Catch.', price: 350, stock: 40, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-prawns')!.imageUrl, imageHint: 'cleaned prawns', sellerId: 'seller-1', subCategory: 'Fresh Seafood (Meen Vagaigal)', tags: ['Fresh Catch'] },
  { id: 'prod-salmon', name: 'Atlantic Salmon Fillet', description: 'Premium, imported Atlantic salmon. Rich in Omega-3s.', price: 750, stock: 20, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-salmon')!.imageUrl, imageHint: 'salmon fillet', sellerId: 'seller-1', subCategory: 'Fresh Seafood (Meen Vagaigal)' },

  // Cold Cuts & Ready-to-Cook
  { id: 'prod-chicken-sausages', name: 'Chicken Sausages', description: 'A pack of classic chicken sausages, perfect for breakfast or snacks.', price: 220, stock: 50, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-chicken-sausages')!.imageUrl, imageHint: 'chicken sausages', sellerId: 'seller-1', subCategory: 'Cold Cuts & Ready-to-Cook' },
  { id: 'prod-chicken-nuggets', name: 'Chicken Nuggets', description: 'Crispy, ready-to-fry chicken nuggets. A favorite with kids.', price: 180, stock: 60, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-chicken-nuggets')!.imageUrl, imageHint: 'chicken nuggets', sellerId: 'seller-1', subCategory: 'Cold Cuts & Ready-to-Cook' },

  // Eggs
  { id: 'prod-white-eggs-meat', name: 'White Eggs', description: 'A dozen fresh, white eggs from the farm.', price: 70, stock: 100, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-eggs-white')!.imageUrl, imageHint: 'carton eggs', sellerId: 'seller-1', subCategory: 'Eggs', tags: ['High Protein'] },
  { id: 'prod-country-eggs-meat', name: 'Country Eggs (Nattu Kozhi Muttai)', description: 'Pack of 6 nutritious country chicken eggs.', price: 90, stock: 80, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-eggs-brown')!.imageUrl, imageHint: 'brown eggs', sellerId: 'seller-1', subCategory: 'Eggs', tags: ['High Protein'] },
  { id: 'prod-quail-eggs', name: 'Quail Eggs (Kaadai Muttai)', description: 'A pack of 12 small, nutrient-dense quail eggs.', price: 60, stock: 70, categoryId: 'meat-seafood', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-quail-eggs')!.imageUrl, imageHint: 'quail eggs', sellerId: 'seller-1', subCategory: 'Eggs', tags: ['High Protein'] },
