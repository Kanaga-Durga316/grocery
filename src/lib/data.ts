...
const products: Product[] = [
  ...
  { id: 'prod-5', name: 'Toned Milk Pouch', description: '500ml Aavin toned milk pouch, a daily essential.', price: 25, stock: 100, categoryId: 'dairy-bakery', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-milk-pouch')!.imageUrl, imageHint: 'milk pouch', sellerId: 'seller-1', subCategory: 'Milk & Fresh Products' },
  { id: 'prod-75', name: 'Full Cream Milk Pouch', description: '500ml Aavin full cream milk pouch, rich and creamy.', price: 30, stock: 80, categoryId: 'dairy-bakery', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-milk-pouch-full')!.imageUrl, imageHint: 'milk pouch', sellerId: 'seller-1', subCategory: 'Milk & Fresh Products' },
  { id: 'prod-76', name: 'Buttermilk Pouch', description: 'Refreshing Neer Mor (spiced buttermilk), perfect for summer (200ml).', price: 15, stock: 120, categoryId: 'dairy-bakery', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-buttermilk')!.imageUrl, imageHint: 'buttermilk glass', sellerId: 'seller-1', subCategory: 'Milk & Fresh Products' },
  ...
  { id: 'prod-9', name: 'Sandwich Bread', description: 'A loaf of soft and fresh white sandwich bread.', price: 40, stock: 50, categoryId: 'dairy-bakery', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-bread')!.imageUrl, imageHint: 'sandwich bread', sellerId: 'seller-2', subCategory: 'Fresh Bakery' },
  { id: 'prod-10', name: 'Butter Croissants', description: 'Pack of 2 flaky, all-butter croissants, a bakery delight.', price: 120, stock: 40, categoryId: 'dairy-bakery', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-croissant')!.imageUrl, imageHint: 'butter croissants', sellerId: 'seller-2', subCategory: 'Fresh Bakery' },
  { id: 'prod-11', name: 'Chocolate Cake Slice', description: 'Rich, decadent chocolate fudge cake slice.', price: 120, stock: 30, categoryId: 'dairy-bakery', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-cake')!.imageUrl, imageHint: 'chocolate cake', sellerId: 'seller-2', subCategory: 'Fresh Bakery' },
  { id: 'prod-12', name: 'Tea Rusk', description: 'Crispy and crunchy tea rusk, perfect for dipping (200g).', price: 50, stock: 100, categoryId: 'dairy-bakery', imageUrl: PlaceHolderImages.find(p => p.id === 'prod-rusk')!.imageUrl, imageHint: 'tea rusk', sellerId: 'seller-2', subCategory: 'Fresh Bakery' },
